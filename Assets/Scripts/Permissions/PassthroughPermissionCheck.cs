...
{
    /// <summary>
    /// Permissions to request passthrough functionality on Meta devices.
    /// https://docs.unity3d.com/Packages/com.unity.xr.meta-openxr@2.2/manual/get-started/scene-setup.html#camera-background-passthrough
    /// </summary>
    public class PassthroughPermissionCheck : MonoBehaviour
    {
